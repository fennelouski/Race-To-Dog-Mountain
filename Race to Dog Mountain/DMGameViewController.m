...
- (void)updateViews {
    ...
    [UIView animateWithDuration:animationTime animations:^{
        [_gridView setFrame:CGRectMake(0.0f,
                                       kStatusBarHeight,
                                       self.numberOfRows * SQUARE_SIZE + BUFFER,
                                       self.numberOfRows * SQUARE_SIZE + BUFFER)];
        ...
        [_userNameLabel setFrame:CGRectMake(0,
                                            _popOver.frame.size.height * 0.4f,
                                            _popOver.frame.size.width,
                                            kScreenHeight/20.0f)];
...
- (UIButton *)popOverBackButton {
    if (!_popOverBackButton) {
        _popOverBackButton = [[UIButton alloc] initWithFrame:CGRectMake(_popOver.frame.size.width/4,
                                                                        _popOver.frame.size.height*4/5,
                                                                        _popOver.frame.size.width/2,
                                                                        30.0f)];
